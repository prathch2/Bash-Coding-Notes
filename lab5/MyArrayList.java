...
public class MyArrayList<T> implements List<T> {
    ...
    public void add(int newPosition, T newEntry) {
        ...
        if (newPosition < 0 || newPosition > size)
            throw new IndexOutOfBoundsException("newPosition must be greater than 0 and newPosition has to be less than size");
    ...
    public T remove(int index) {
        if (index < 0 || index >= size)
            throw new IndexOutOfBoundsException("index must be greater than 0 and index has to be less than size");

        T removeListElement = array[index];
